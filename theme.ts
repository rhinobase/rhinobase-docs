...
const customTheme = extendTheme({
  ...
  semanticTokens: {
    colors: {
      ...
      accent: { default: "messenger.500", _dark: "messenger.300" },
      "accent-emphasis": { default: "messenger.700", _dark: "messenger.200" },
      "accent-static": "messenger.500",
      "accent-muted": { default: "messenger.300", _dark: "messenger.200" },
      "accent-subtle": { default: "messenger.50", _dark: "messenger.800" },
