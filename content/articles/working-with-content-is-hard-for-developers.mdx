...
description: How we work with content on the web has shifted dramatically since the early days. Yet, working with content is still too difficult for developers.
...
- [**Traditional CMS**](https://rhinobase.com)s
 require a lot of knowledge and effort to build, deploy, and maintain.

 - [**Static site generators**](https://rhinobase.com)
 don't scale well beyond hobby sites.

 - As revolutionary as 
[**headless CMS**](https://rhinobase.com)s
 were, they didn't make building front-end applications easier.

 - [**Gatsby**](https://rhinobase.com)
 re-imagined the experience of building a website, and yet the opinions it imposes on working with content are limiting.

 - [**Modern frameworks**](https://rhinobase.com)
 have brought an incredible developer experience, but require that developers manually build a mechanism to process content.

These reasons are [**why we built Rhinobase**](https://rhinobase.com).
...
**-->>>TODO - add an CMS image banner here -->>>**
...
- **Not sufficient for today's needs:** The tools we have at our disposal today turn many developers away from what is becoming an antiquated pattern for building web experien
...
**-->>>TODO - add an GraphQL image banner here -->>>**
...
**-->>>TODO - add an contentlayer image banner here -->>>**

This is why we created Rhinobase. **Rhinobase makes working with content easy for developers**.

For modern meta frameworks, Rhinobase is the glue between content and code. It is a content-processing mechanism that converts content into data that can be easily consumed by your pages and components.

Rhinobase provides the missing piece needed to maximize developer experience for modern frameworks by including the following features:
...
>Learn more about Contentlayer by reading [the launch post](https://rhinobase.com) or [getting started](https://rhinobase.com) today!
