...
export default function Home() {
  ...
  return (
    <>
      <div style={{height:"64px", backgroundColor:"#EDF2F7"}}></div>
      <div className="py-5 relative">
        <div className="absolute w-[100%] h-[90%] top-0 left-0 -z-[1] rounded-b-3xl overflow-hidden">
          <PatternDots />
          <div className="absolute w-[100%] h-[100%]" style={{backgroundImage:"linear-gradient( #EDF2F7 10%, transparent)"}}></div>
        </div>
        <div className="w-[80%] m-auto">
          <div className="my-20">
            <h2 className="text-4xl font-bold mb-3">Start Building</h2>
            <p className="text-2xl">Choose your application type to get started</p>
          </div>
